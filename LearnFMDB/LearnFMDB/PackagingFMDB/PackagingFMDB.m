...
#import "PackagingFMDB.h"
#import "Person.h"
#import "RWFMDB.h"
#import "ProductionView.h"


@interface PackagingFMDB ()

@end

@implementation PackagingFMDB
...
- (void)viewDidLoad {
    ...
    RWFMDB *db = [RWFMDB shareDatabase];
...
#pragma mark - *************** 所有插入操作
- (void)insertMethod:(ProductionView *)proViews db:(RWFMDB *)db model:(Person *)person array:(NSMutableArray *)mArr
{
    //插入一条数据
...
#pragma mark - *************** 所有删除操作
- (void)deleteMethod:(ProductionView *)proViews db:(RWFMDB *)db model:(Person *)person array:(NSMutableArray *)mArr
{
    //删除最后一条数据
...
#pragma mark - *************** 所有更新操作
- (void)updateMethod:(ProductionView *)proViews db:(RWFMDB *)db model:(Person *)person array:(NSMutableArray *)mArr
{
    [proViews updateMethod1:^{
...
#pragma mark - *************** 所有查找操作
- (void)lookupMethod:(ProductionView *)proViews db:(RWFMDB *)db model:(Person *)person array:(NSMutableArray *)mArr
{
...
#pragma mark - *************** 事务操作
- (void)transactionMethod:(ProductionView *)proViews db:(RWFMDB *)db model:(Person *)person array:(NSArray *)mArr
{
