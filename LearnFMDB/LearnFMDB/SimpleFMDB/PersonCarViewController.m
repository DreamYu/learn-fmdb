...
@interface PersonCarViewController ()
...
//        [[DataBase shareDataBase] deleteCar:car fromPerson:self.person];
        [[DataBase shareDataBase] deleteAllCarsFromPerson:self.person];
//        [[DataBase shareDataBase] updateCar:car fromPerson:self.person];
        self.carArray = [[DataBase shareDataBase] getAllCarsFromPerson:self.person];
